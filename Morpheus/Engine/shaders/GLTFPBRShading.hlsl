...
#include "GLTFPBRStructures.hlsl"
#include "GLTFPBRCommon.hlsl"
#include "GLTFShaderUtilities.hlsl"
...
SurfaceReflectanceInfo GLTF_PBR_GetSurfaceReflectance(float4     BaseColor,
													  float      Metallic,
													  float      Roughness)
{
