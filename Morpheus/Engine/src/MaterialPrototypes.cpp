...
namespace Morpheus {
	...
	MaterialPrototypeFactory::MaterialPrototypeFactory() {
		...
		mMap["GLTFStaticMeshPBRMaterial"] = 
			&AbstractConstructor<GLTFStaticMeshPBRMaterialPrototype>;
	...
	GLTFStaticMeshPBRMaterialPrototype::GLTFStaticMeshPBRMaterialPrototype(
	...
	DG::IBuffer* GLTFStaticMeshPBRMaterialPrototype::CreateMaterialInfoBuffer(
	...
	GLTFStaticMeshPBRMaterialPrototype::GLTFStaticMeshPBRMaterialPrototype(
		...
		std::string pipeline_src = 	"GLTFPBRStaticMesh";
	...
	void GLTFStaticMeshPBRMaterialPrototype::InitializeMaterial(
		ResourceManager* manager,
		ResourceCache<MaterialResource>* cache,
		MaterialResource* into) {
	...
	MaterialPrototype* GLTFStaticMeshPBRMaterialPrototype::DeepCopy() const {
		return new GLTFStaticMeshPBRMaterialPrototype(*this);
	}
